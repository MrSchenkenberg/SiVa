...
public class TimeStampTokenValidationServiceTest {
    ...
    public void validTimeStampToken() {
        ...
        Assertions.assertEquals(TimeStampTokenValidationData.Indication.TOTAL_PASSED, validationData.getIndication());
        Assertions.assertEquals("SK TIMESTAMPING AUTHORITY", validationData.getSignedBy());
    ...
    public void certificatePresent() throws Exception{
        ...
        Assertions.assertEquals(1, timeStampTokenValidationData.getCertificates().size());

        ee.openeid.siva.validation.document.report.Certificate certificate = timeStampTokenValidationData.getCertificates().get(0);
        Assertions.assertEquals(CertificateType.CONTENT_TIMESTAMP, certificate.getType());
        Assertions.assertEquals("SK TIMESTAMPING AUTHORITY", certificate.getCommonName());
        ...
        Assertions.assertEquals("SK TIMESTAMPING AUTHORITY", CertUtil.getCommonName((X509Certificate) timeStampCertificate));
